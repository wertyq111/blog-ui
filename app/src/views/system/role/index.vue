<template>
  <div class="ele-body develop-page admin-workspace-page admin-workspace-page--role">
    <el-card shadow="never" class="develop-shell admin-workspace-shell">
      ...
      <section class="develop-hero">
        <div class="develop-hero__copy">
          ...
          <div class="develop-hero__title">角色管理</div>
          <div class="develop-hero__desc">维护角色标识、授权能力与状态信息，统一后台权限角色体系。</div>
        </div>
      </section>
      ...
      <section class="develop-table-shell">
        <div class="develop-table-shell__header">
          <div>
            ...
            <div class="develop-table-shell__desc">支持批量删除、角色编辑与权限维护。</div>
          </div>
        </div>
      <ele-pro-table
        ref="table"
