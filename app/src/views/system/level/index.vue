<template>
  <div class="ele-body develop-page admin-workspace-page admin-workspace-page--level">
    <el-card shadow="never" class="develop-shell admin-workspace-shell">
      ...
      <section class="develop-hero">
        <div class="develop-hero__copy">
          ...
          <div class="develop-hero__title">职级管理</div>
          <div class="develop-hero__desc">维护职级名称、状态与排序规则，统一后台职级体系。</div>
        </div>
      </section>
      ...
      <section class="develop-table-shell">
        <div class="develop-table-shell__header">
          <div>
            <div class="develop-table-shell__title">职级列表</div>
            <div class="develop-table-shell__desc">支持批量操作、导入导出和状态切换。</div>
          </div>
        </div>
      <ele-pro-table
        ref="table"
