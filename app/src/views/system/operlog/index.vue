<template>
  <div class="ele-body develop-page admin-workspace-page admin-workspace-page--operlog">
    <el-card shadow="never" class="develop-shell admin-workspace-shell">
      ...
      <section class="develop-hero">
        <div class="develop-hero__copy">
          ...
          <div class="develop-hero__title">操作日志</div>
          <div class="develop-hero__desc">查看后台操作轨迹与审计记录，统一沉淀关键操作行为。</div>
        </div>
      </section>
      ...
      <section class="develop-table-shell">
        <div class="develop-table-shell__header">
          <div>
            <div class="develop-table-shell__title">操作日志列表</div>
            <div class="develop-table-shell__desc">支持按账号与模块筛选并查看详细记录。</div>
          </div>
        </div>
      <ele-pro-table
        ref="table"
