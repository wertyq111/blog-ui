<template>
  <div class="ele-body develop-page admin-workspace-page admin-workspace-page--photo-category">
    <el-card shadow="never" class="develop-shell admin-workspace-shell">
      ...
      <section class="develop-hero">
        <div class="develop-hero__copy">
          ...
          <div class="develop-hero__title">相册管理</div>
          <div class="develop-hero__desc">维护相册名称与排序规则，统一照片内容的归类入口。</div>
        </div>
      </section>
      ...
      <section class="develop-table-shell">
        <div class="develop-table-shell__header">
          <div>
            <div class="develop-table-shell__title">相册列表</div>
            <div class="develop-table-shell__desc">支持相册筛选与基础信息维护。</div>
          </div>
        </div>
      <ele-pro-table
        ref="table"
